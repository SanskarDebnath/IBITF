  ...
  useEffect(() => {
    const loadInitial = async () => {
      try {
        ...
        setImageName(product.image ? "Current image" : "");
      } catch (err) {
  ...
  return (
    <div className="seller-form-page">
      <div className="seller-form-header">
        <div>
          <h1>Edit Product</h1>
          <p>Update your listing and inventory details.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="seller-form">
        ...
        <div className="seller-form-actions">
          ...
          <button type="submit" className="seller-primary-btn">Save Changes</button>
        </div>
      </form>
    </div>
  );
